        ...
        void Load_data()
        {
            ...
            if (drpList.SelectedValue == "0")
            {
                ...
                foreach (int i in droplistNumbers)
                {
                    ...
                    foreach (DateTime day in EachCalendarDay(StartDate, EndDate))
                    {
                        ...
                        table.Append("<div style='position: relative;margin-right:8px'><button onClick='Down_Excel(\"" + dropListNames[i].Replace(' ', 'a') + (i + l) + "\")' class='downloadBtnClass' id='" + dropListNames[i] + forDate + "'>");
                        table.Append("<img src='img/excel2.jpg' height='20'/></button></div>");
            ...
            else
            {
                foreach (DateTime day in EachCalendarDay(StartDate, EndDate))
                {
                    ...
                    // ----------------- Excel Download Button Section -----------------------
                    table.Append("<div style='position: relative; margin-right:8px'><button id='" + forDate + "'  onClick='Down_Excel(\"" + forDate.Replace('/', 'a') + "\")' class='downloadBtnClass'>");
                    table.Append("<img src='img/excel2.jpg' height='20'/></button></div>");
